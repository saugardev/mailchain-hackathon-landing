export default function Installation() {
  return (
    <div className="container mx-auto">
      ...
      <p className="mb-8">
        Installing an Mailchain UI Components is a simple process. Here&apos;s how you can do it:
      </p>
      <h3 className="text-xl font-bold mb-2">For Angular:</h3>
      ...
      <h3 className="text-xl font-bold mb-2">For React:</h3>
      <ul className="list-disc pl-8 mb-8">
        <li className="mb-2">Open your terminal or command prompt</li>
        <li className="mb-2">Navigate to your project directory</li>
